    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Departments</h1>
            </div>

            <!-- Right: Actions -->
            <div class="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                @can('create departments')
                <a href="{{ route('master.departments.create') }}" class="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">
                    <svg class="fill-current shrink-0 xs:hidden" width="16" height="16" viewBox="0 0 16 16">
                        <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                    </svg>
                    <span class="max-xs:sr-only ml-2">Add Department</span>
                </a>
                @endcan
            </div>
        ...
        <!-- Search and Filter -->
        <div class="mb-5">
            <form method="GET" action="{{ route('master.departments.index') }}" class="sm:flex sm:gap-4">
                ...
                <table class="table-auto w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <thead class="text-xs uppercase text-gray-500 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/20 border-t border-gray-200 dark:border-gray-700">
                        <tr>
                            ...
                            <th class="px-4 py-3 whitespace-nowrap">
                                <div class="font-semibold text-center">Users</div>
                            </th>
                            <th class="px-4 py-3 whitespace-nowrap">
                        ...
                        <tr>
                            <td class="px-4 py-3 whitespace-nowrap w-px">
                                <div class="flex items-center">
                                    <div class="w-2.5 h-2.5 rounded-full {{ $department->is_active ? 'bg-green-500' : 'bg-gray-400' }}"></div>
                                </div>
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap">
                                <div class="font-medium text-gray-800 dark:text-gray-100">{{ $department->code }}</div>
                            </td>
                            <td class="px-4 py-3">
                                <div class="text-gray-800 dark:text-gray-100">{{ $department->name }}</div>
                            </td>
                            <td class="px-4 py-3">
                                <div class="text-gray-600 dark:text-gray-400">{{ Str::limit($department->description, 50) }}</div>
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap text-center">
                                <div class="text-gray-600 dark:text-gray-400">{{ $department->users_count }}</div>
                            </td>
                            <td class="px-4 py-3 whitespace-nowrap text-center">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <a href="{{ route('master.departments.show', $department) }}" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" title="View">
                                    ...
                                    <a href="{{ route('master.departments.edit', $department) }}" class="text-blue-400 hover:text-blue-600" title="Edit">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <form action="{{ route('master.departments.destroy', $department) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this department?');">
                                        @csrf
                                        @method('DELETE')
