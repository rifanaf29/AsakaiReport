                    ...
                    <div id="actual-aggregation-settings" class="mt-4 hidden">
                        <div class="mb-4">
                            ...
                            >
                                ...
                                <option value="formula" {{ old('actual_aggregation', $kpiTemplate->actual_aggregation) === 'formula' ? 'selected' : '' }}>Formula</option>
                            </select>
                        ...
                        <div id="actual-formula-wrapper" class="hidden mt-4">
                            ...
                            <input
                                ...
                                name="actual_formula"
                                id="actual_formula"
                                value="{{ old('actual_formula', $kpiTemplate->actual_formula) }}"
                            ...
                            <div class="grid grid-cols-12 gap-3 items-start">
                                ...
                                <div class="col-span-12 sm:col-span-2">
                                    ...
                                    >
                                        ...
                                        <option value="accounting" {{ $field->field_type == 'accounting' ? 'selected' : '' }}>Accounting</option>
