...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::prefix('kpi')->name('kpi.')->group(function () {
        ...
        Route::patch('entries/{entry}/lock', [KpiEntryController::class, 'lock'])->name('entries.lock');
        Route::patch('entries/{entry}/unlock', [KpiEntryController::class, 'unlock'])->name('entries.unlock');
    });
